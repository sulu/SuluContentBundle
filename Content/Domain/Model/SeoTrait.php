...
trait SeoTrait
{
     ...
     * @return mixed[]
     */
    public function setSeoData(array $data): array
    {
        $seoTitle = 'seoTitle';
        ...
        if (array_key_exists($seoHideInSitemap, $data)) {
            ...
            $this->setSeoHideInSitemap($value);
